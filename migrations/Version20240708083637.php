 ...
 */
final class Version20240708083637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE created_at created_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE created_at created_at DATE DEFAULT NULL');
